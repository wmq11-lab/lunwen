...
多智能体系统（Multi-Agent System,\allowbreak MAS）是由多个具有自主能力的智能体（Agent）组成的计算系统，智能体之间通过协作完成复杂任务~\cite{Wooldridge2009MAS}。与单一智能体相比，多智能体系统在问题分解、信息集成、容错冗余及并行处理等方面具有显著优势~\cite{Stone2000MultiAgent}。
