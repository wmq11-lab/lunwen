...
\textbf{（2）变更感知测试数据集。}从typer项目Git提交历史中选取多个真实提交。
...
\begin{axis}[
    ...
    clip=false,
    nodes near coords,
    nodes near coords style={font=\fontsize{4}{5}\selectfont, inner sep=0.5pt},
...
\begin{axis}[
    ...
    nodes near coords,
    nodes near coords style={font=\fontsize{4}{5}\selectfont, inner sep=0.5pt},
    every node near coord/.append style={anchor=south, yshift=2.5pt, rotate=35},
]
...
\begin{axis}[
    ...
    clip=false,
    nodes near coords,
    nodes near coords style={font=\fontsize{5}{6}\selectfont, inner sep=0.5pt},
